...
SYLLABUS_SECTIONS = [
    {
        ...
        "items": [
            item(
                "sets",
                "Sets",
                "WAEC-aligned treatment of sets: notation, types, subsets, Venn diagrams, operations, laws, cardinality and word problems.",
                [
                    "Module 1: Introduction to sets, well-defined collections, roster method and set-builder notation.",
                    "Module 2: Types of sets: finite, infinite, equal, equivalent, empty and universal sets.",
                    "Module 3: Subsets, proper subsets and number of subsets using $2^n$.",
                    "Module 4: Venn diagrams, regions, universal set interpretation and shaded-region identification.",
                    "Module 5: Set operations: union, intersection, complement and difference.",
                    "Module 6: Laws of sets: commutative, associative, distributive, identity and De Morgan's laws.",
                    "Module 7: Cardinality: $n(A)$, two-set formula and basic three-set formula.",
